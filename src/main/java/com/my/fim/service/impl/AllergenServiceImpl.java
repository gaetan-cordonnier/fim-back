...
public class AllergenServiceImpl implements AllergenService {
    ...
    public AllergenDto getAllergenById(Long id) {
        Allergen allergen = allergenRepository.findById(id).orElseThrow(()->new NotFoundExceptionMessage("Allergène non trouvé"));
        return mapToDto(allergen);
    }
    @Override
    public AllergenDto updateAllergenById(AllergenDto allergenDto, Long id) {
        Allergen allergen = allergenRepository.findById(id).orElseThrow(()->new NotFoundExceptionMessage("Impossible de mettre à jour l'allergène"));
    ...
    public void deleteAllergenById(Long id) {
        Allergen allergen = allergenRepository.findById(id).orElseThrow(()->new NotFoundExceptionMessage("Impossible de supprimer l'allergène"));
